...
class Discrete4TurtleGym(gym.Env):
	def __init__(self):
...
class Discrete15TurtleGym(gym.Env):
	def __init__(self):
		super(Discrete15TurtleGym,self).__init__()		
		metadata = {'render.modes': ['console']}
		print("Initialising Turtlebot 3 Discrete 15 Gym Environment...")
